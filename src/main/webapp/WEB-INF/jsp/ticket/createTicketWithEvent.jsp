...
<body>
	<div class="col-sm-6 col-sm-offset-4" id="createTicketContainer">
		...
		<form:form modelAttribute="ticket"
			...
			<br />
			<input class="btn-success col-sm-4 col-sm-offset-5" id="buttonTicket"
				type="submit" value="Buy" onclick="changeActionUri();">
